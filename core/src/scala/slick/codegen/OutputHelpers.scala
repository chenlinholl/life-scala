...
trait OutputHelpers {
  ...
  /**
    ...
    */
  def writeToFile(profile: String, folder: String, pkg: String, container: String = "BaseEntityTable", fileName: String = "BaseEntityTable.scala"): Unit = {
  ...
  /**
    ...
    * @param container The name of a trait and an object the generated code will be placed in within the specified package.
    */
  def writeToMultipleFiles(profile: String, folder: String, pkg: String, container: String = "BaseEntityTable"): Unit = {
